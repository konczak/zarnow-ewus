...
import pl.konczak.nzoz.ewus.client.old.broker.Payload;
import pl.konczak.nzoz.ewus.client.old.broker.ServiceLocation;
import pl.konczak.nzoz.ewus.client.old.broker.ServiceRequest;
import pl.konczak.nzoz.ewus.client.old.broker.ServiceResponse;
import pl.konczak.nzoz.ewus.client.old.xsd.StatusCwuPyt;
...
public class ServiceBrokerClient
    ...
    private final pl.konczak.nzoz.ewus.client.old.xsd.ObjectFactory objectFactory;

    private final Jaxb2Marshaller marshaller;

    public ServiceBrokerClient(Jaxb2Marshaller marshaller) {
        this.brokerObjectFactory = new ObjectFactory();
        this.objectFactory = new pl.konczak.nzoz.ewus.client.old.xsd.ObjectFactory();
        this.marshaller = marshaller;
    }

    public void call(String pesel, LoginResponse loginResponse) {
        pl.konczak.nzoz.ewus.client.old.xsd.System system = objectFactory.createSystem();
